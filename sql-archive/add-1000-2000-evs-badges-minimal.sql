-- Script minimalista para adicionar badges de marcos de EVS
...
-- 3. Adicionar badge para 1000 EVS (apenas colunas essenciais)
INSERT INTO badges (name, description, icon) VALUES
    ('1000_evs_milestone', 'Marco dos 1000 EVS', '🎯')
ON CONFLICT (name) DO UPDATE SET
    description = EXCLUDED.description,
    icon = EXCLUDED.icon;

-- 4. Adicionar badge para 2000 EVS (apenas colunas essenciais)
INSERT INTO badges (name, description, icon) VALUES
    ('2000_evs_milestone', 'Marco dos 2000 EVS', '🏆')
ON CONFLICT (name) DO UPDATE SET
    description = EXCLUDED.description,
    icon = EXCLUDED.icon;
