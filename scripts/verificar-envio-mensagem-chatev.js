// Script para verificar especificamente o problema do envio de mensagem no ChatEV
// Execute este script no console do navegador na página /chat

console.log('🔍 VERIFICANDO ENVIO DE MENSAGEM NO CHATEV');
console.log('========================================');

const verificarEnvioMensagemChatEV = async () => {
  try {
