// Script para verificar especificamente o problema de contexto de autenticação no ChatEV
// Execute este script no console do navegador na página /chat

console.log('🔍 VERIFICANDO CONTEXTO DE AUTENTICAÇÃO NO CHATEV');
console.log('==============================================');

const verificarContextoAuthChatEV = async () => {
  try {
